...
CREATE TABLE user_supplement_adoptions (
...
CREATE INDEX user_supplement_adoptions_user_idx ON user_supplement_adoptions(user_id);
CREATE INDEX user_supplement_adoptions_date_idx ON user_supplement_adoptions(user_id, adopted_at);
